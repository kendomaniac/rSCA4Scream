...
#'}
#' @export
autoencoder4pseudoBulkGPU <- function(group=c("sudo","docker"), scratch.folder, file,separator, permutation, nEpochs,patiencePercentage=5,seed=1111,projectName,bN,lr=0.01,beta_1=0.9,beta_2=0.999,epsilon=0.00000001,decay=0.0,loss="mean_squared_error",regularization=10){
    bias="CUSTOM"
